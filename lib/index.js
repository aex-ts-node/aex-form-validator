...
module.exports = {
   ...
   * @returns {boolean}
   */
  v: function(req, confs, data, error, paramType) {
    var params = [];
    var ignores = [];
    ...
    if (!this.extract(req, data, params, paramType)) {
      return false;
    }
  ...
  extract: function(req, data, params, paramType) {
    paramType = paramType || 'body';
    if (!params || !params.length || !data || !req || !req[paramType]) {
      return false;
    }
